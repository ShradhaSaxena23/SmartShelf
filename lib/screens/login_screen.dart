...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: isDesktop ? _buildSplitScreenLayout(context) : _buildMobileLayout(context),
      ),
    );
  }

  // ==========================================
  // SPLIT SCREEN LAYOUT (Logo Left, Sign In Form Right)
  // ==========================================
  Widget _buildSplitScreenLayout(BuildContext context) {
    ...
    return Row(
      children: [
        // Left Side: Brand Logo Card Center
        Expanded(
          flex: 5,
          child: Container(
                ...
                child: ConstrainedBox(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        // Top Right: New to SmartShelf? Sign up
                        Row(
                        ...
                        // Email Field
                        const Text('Email / Phone', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14, color: AppTheme.textPrimary)),
                        const SizedBox(height: 8),
                        TextFormField(
                        ...
                        // Password Field
                        const Text('Password', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14, color: AppTheme.textPrimary)),
                        const SizedBox(height: 8),
                        TextFormField(
                        ...
                        // Social Buttons Side-By-Side (Matching Reference Screenshot)
                        Row(
                          children: [
                            Expanded(
